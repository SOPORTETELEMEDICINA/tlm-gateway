...
public class ConsultaEventoException extends GenericException {
//   private final ExceptionServiceCode MODULE_CODE = ExceptionServiceCode.NIOGATEWAY;
   ...
   public ConsultaEventoException(Exception ex, String message, String layer, String action){
      super(ex,message);
      this.layer = layer;
      this.action = action;
   }

   public ConsultaEventoException(String message, String layer, String action){
      super(message);
      this.layer = layer;
      this.action = action;
   }
